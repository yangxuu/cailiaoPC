  ...
  <div>
      ...
      <div class="right">
        ...
        <ul class="list">
          ...
          <li>
            ...
            <span class="color-b">{{info.shop.mobile||'暂无'}}</span>
          </li>
          <li>
        ...
        <div class="contact clear">
          ...
          <div class="connect">
            ...
            <p>{{info.shop.link_man}}</p>
            <p class="phone">联系方式：</p>
            <p>{{info.shop.tele}}</p>
          </div>
        </div>
      </div>
    ...
    <div class="safe auto m-t-50 navbar">
      ...
      <div class="product-show">
        <!-- <router-link to="/product" class="product-show" style="display:block"> -->
        <router-link
          :to="{path:'/detail',query:{id:item.id}}"
          class="div"
          style="display:block"
          v-for="(item,index) in list.item_list"
          :key="index+'p'"
        >
          <div class="img-box">
    ...
    <div class="safe auto m-t-50">
      <div class="container">
        <div class="left">
          ...
          <!-- <li class="list" v-for="x in 10" :key="x+'1'">类目名称1</li> -->
        ...
        <div class="right">
          ...
          <div class="col-2" :style="type==0?'':'display:none;'">
            ...
            <div class="pictures" v-for="(item,index) in info.shop_item_img_list" :key="index+'b'">
              <div class="img-box">
                <img :src="item.file" alt>
              </div>
            </div>
...
.navbar > .head > .header {
  ...
  width: 228px;
  height: 37px;
  /* background: url(../assets/images/detail-head.png) no-repeat; */
}
.product-show {
  width: 100%;
  height: 320px;
