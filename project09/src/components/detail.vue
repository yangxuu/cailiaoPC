...
#left {
  background-image: url(http://files.cailiao.com/vue/cailiao/pc_9/images/arrow1.png);
  background-repeat: no-repeat;
  background-position: center;
}

#right {
  background-image: url(http://files.cailiao.com/vue/cailiao/pc_9/images/arrow2.png);
  background-repeat: no-repeat;
  background-position: center;
}
#view {
...
.contact .icon-box {
  width: 42px;
  height: 43px;
  background-image: url(http://files.cailiao.com/vue/cailiao/pc_9/images/icon-5.png);
}
...
.btn .ask .ico {
  ...
  background-image: url(http://files.cailiao.com/vue/cailiao/pc_9/images/icon-01.png);
  position: relative;
  top: -2px;
}
...
.spe .ico1 {
  ...
  height: 18px;
  vertical-align: middle;
  background-image: url(http://files.cailiao.com/vue/cailiao/pc_9/images/icon-02.png);
  position: relative;
  top: -2px;
}
...
.recom .ico2 {
  ...
  height: 20px;
  vertical-align: middle;
  background-image: url(http://files.cailiao.com/vue/cailiao/pc_9/images/icon-3.png);
  position: relative;
  top: -4px;
}
...
.view-b .left .info .row1 .icon-2 {
  ...
  width: 17px;
  height: 17px;
  background-image: url(http://files.cailiao.com/vue/cailiao/pc_9/images/icon-2.png);
...
.info .head {
  ...
  text-align: center;
  line-height: 70px;
  background-image: url(http://files.cailiao.com/vue/cailiao/pc_9/images/icon-6.png);
  background-repeat: no-repeat;
}
...
.shop .ico3 {
  ...
  height: 18px;
  vertical-align: middle;
  background-image: url(http://files.cailiao.com/vue/cailiao/pc_9/images/icon-4.png);
  position: relative;
  top: -2px;
  left: -5px;
}
