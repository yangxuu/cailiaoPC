...
.banner-box {
  ...
  background-image: url(http://files.cailiao.com/vue/cailiao/pc_13/images/new-ban2.jpg);
}
.pro-container {
  width: 100%;
  margin-top: 21px;
...
.left .icon-head {
  ...
  font-size: 14px;
  color: white;
  background: url(http://files.cailiao.com/vue/cailiao/pc_13/images/icon-head.png) no-repeat;
}
.left .list {
  width: 95%;
  /* margin: 0 auto; */
...
.btn1 {
  background-image: url(http://files.cailiao.com/vue/cailiao/pc_13/images/btn1.png);
  background-repeat: no-repeat;
  background-size: 100% 100%;
}
.btn11 {
  background-image: url(http://files.cailiao.com/vue/cailiao/pc_13/images/btn11.png);
  background-repeat: no-repeat;
  background-size: 100% 100%;
}
.bread-nav .btn22 {
  background-image: url(http://files.cailiao.com/vue/cailiao/pc_13/images/btn22.png);
  background-repeat: no-repeat;
  background-size: 100% 100%;
}
.btn2 {
  background-image: url(http://files.cailiao.com/vue/cailiao/pc_13/images/btn2.png);
  background-repeat: no-repeat;
  background-size: 100% 100%;
}
.orderTime {
