...
.up .t-0 {
  width: 41px;
  height: 41px;
  background-image: url(http://files.cailiao.com/vue/cailiao/pc_19/images/t-1.png);
}
.up .t-1 {
  width: 41px;
  height: 41px;
...
.down .t-0 {
  width: 41px;
  height: 41px;
  background-image: url(http://files.cailiao.com/vue/cailiao/pc_19/images/t-2.png);
}
.down .t-1 {
  width: 100px;
  height: 41px;
