<template>
  <div>
    ...
    <div class="floor">
      ...
      <!-- <p class="row2">专业网络营销提供商 为您提供优质的网络营销解决方案！</p> -->
    </div>
    <div class="bg-light">
      ...
      <!-- <div class="arrow">
        <span class="arrow-l" @click="prev"></span>
        <span class="arrow-r" @click="next"></span>
      </div>-->
    </div>
    <div class="floor3">
...
.arrow .arrow-l {
  ...
  height: 31px;
  cursor: pointer;
  background-image: url(../assets/images/yx_10.png);
  background-size: 100% 100%;
}
.arrow .arrow-r {
  display: inline-block;
  ...
  cursor: pointer;
  background-size: 100% 100%;
  background-image: url(../assets/images/yx_11.png);
}
.arrow .arrow-l1 {
  display: inline-block;
  width: 44px;
  ...
  cursor: pointer;
  background-size: 100% 100%;
  background-image: url(../assets/images/yx_9.png);
}
.arrow .arrow-r1 {
  display: inline-block;
  width: 44px;
  ...
  cursor: pointer;
  background-size: 100% 100%;
  background-image: url(../assets/images/yx_8.png);
} */
/* floor3 */
.floor3 {
  width: 100%;
