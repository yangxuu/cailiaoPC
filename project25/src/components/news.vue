<template>
  <div>
    <div class="banner-box">
      <img src="http://files.cailiao.com/vue/cailiao/pc_18/images/new-ban4.jpg" alt />
    </div>
...
.icon-head {
  ...
  font-size: 14px;
  color: white;
  background: url(http://files.cailiao.com/vue/cailiao/pc_18/images/icon-head2.png)
    no-repeat;
}
.right .top .list {
  padding: 0 14px 14px;
