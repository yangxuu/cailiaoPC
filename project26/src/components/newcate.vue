...
export default {
  ...
  created() {
    let _this = this;
    _this.flag1 =localStorage.getItem("new_cate_flag");
    _this.flag =localStorage.getItem("new_cate_flag0");
    // 判断state
    _this.api(
  ...
  methods: {
    ...
    style(index, id) {
      let _this = this;
      _this.flag = index;
      localStorage.setItem("new_cate_flag0",index)
      // 二级类目parent_id:当前id
      _this.api(
        "shop/catemgr",
        {
    ...
    second(index, id) {
      let _this = this;
      _this.flag1 = index;
      localStorage.setItem("new_cate_flag",index)
      _this.api(
        "shop/item_list",
        {
          user_id: window._global.user_id,
